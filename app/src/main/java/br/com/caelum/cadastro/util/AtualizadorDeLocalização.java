 ...
 */
public class AtualizadorDeLocalização implements GoogleApiClient.ConnectionCallbacks,LocationListener,GoogleApiClient.OnConnectionFailedListener{

    private GoogleApiClient client;
    private MapaFragment mapa;


    public AtualizadorDeLocalização(Context context, MapaFragment mapa) {
        this.mapa = mapa;
